...
object CheckYourAnswersViewModel {
  ...
  def apply(pensionProviderName: String,
    ...
    val journeyConfirmationLines: Seq[CheckYourAnswersConfirmationLine] = {
      ...
      val optionalPhoneNoLine = phoneNumber map { CheckYourAnswersConfirmationLine(Messages("tai.phoneNumber"), _, controllers.pensions.routes.AddPensionProviderController.addTelephoneNumber().url) }
