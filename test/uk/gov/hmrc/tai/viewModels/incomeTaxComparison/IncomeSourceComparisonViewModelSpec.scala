  ...
  "IncomeSourceComparisonViewModel" should {
    "return an employment sequence" when {
      "CY and CY+1 items are supplied to the view model" in {
        ...
        val employmentCY = Employment("employment1", None, new LocalDate(), None, "", "", 1, None, false, false)
    ...
    "return a pension sequence" when {
      "CY and CY+1 items are supplied to the view model" in {
        ...
        val employmentCY =
          Employment("Pension1", Some("3ABC"), new LocalDate(2017, 3, 1), None, "DIST3", "PAYE3", 3, None, false, false)
    ...
    "return a not applicable value for CY and CY+1" when {
      "CY and CY+1 do not have a matching pension ids" in {
        ...
        val employmentCY = Employment("employment1", None, new LocalDate(), None, "", "", 3, None, false, false)
