...
class IncomeTaxComparisonControllerSpec
  ...
  val employment = Employment("employment1", None, new LocalDate(), None, "", "", 1, None, false, false)
  val employment2 = Employment("employment2", None, new LocalDate(), None, "", "", 2, None, false, false)
  val pension = Employment("employment3", None, new LocalDate(), None, "", "", 3, None, false, true)
  val pension2 = Employment("employment4", None, new LocalDate(), None, "", "", 4, None, false, true)
